...
class App extends Component {
    ...
    componentDidMount() {
        this.fetchAppList();
        this.scrollListener = this.rootScrollContainer.current.addEventListener("scroll", () => {
    ...
    componentWillUnmount() {
        //this.rootScrollContainer.current.removeListener(this.scrollListener);
    ...
    render() {
        return (
            <div className="app-wrapper" ref={this.rootScrollContainer}>
                <Search/>
